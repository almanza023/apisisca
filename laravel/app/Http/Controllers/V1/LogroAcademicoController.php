...
class LogroAcademicoController extends Controller
{
    protected $user;
    protected $model;
    ...
    {
        //Validamos los datos
        $data = $request->only('sede_id', 'periodo_id', 'grado_id', 'asignatura_id', 'tipo_logro_id', 'descripcion');
        $validator = Validator::make($data, [
            'sede_id' => 'required',
            'periodo_id' => 'required',
            'grado_id' => 'required',
            'asignatura_id' => 'required',
            'tipo_logro_id' => 'required',
        ...
        return response()->json([
            'code'=>200,
            'message' => 'Logro Académico Creado Exitosamente',
        ], Response::HTTP_OK);
    }
    ...
    public function filtrar(Request $request)
    {
        ...
        $objeto = $this->model::filtrar($request->sede_id, $request->grado_id,
         $request->asignatura_id, $request->periodo_id, $request->tipo_logro_id);
