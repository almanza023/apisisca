...
class AsignaturaController extends Controller
{
    ...
    {
        //Validamos los datos
        $data = $request->only('nombre', 'acronimo', 'tipo_asignatura_id');
        $validator = Validator::make($data, [
            'nombre' => 'required|max:200|string',
            'acronimo' => 'required|string',
            'tipo_asignatura_id' => 'required',
        ]);
        ...
        $objeto = $this->model::create([
            ...
            'acronimo'=>strtoupper($request->nivel),
            'tipo_asignatura_id'=>($request->tipo_asignatura_id)
        ]);
    ...
    public function getByTipoAsignatura($id)
    {
        //Listamos todos los registros activos
        $objeto=$this->model::getByTipoAsignatura($id);
       if($objeto){
        return response()->json([
            'code'=>200,
            'data' => $objeto
