...
class LogroDisciplinarioController extends Controller
{
    protected $user;
    protected $model;
    ...
    public function __construct(Request $request)
    {
        ...
        $this->model=LogroDisciplinario::class;
        if($token != '')
    ...
    {
        //Validamos los datos
        $data = $request->only('sede_id', 'periodo_id', 'grado_id', 'asignatura_id', 'descripcion');
        ...
        return response()->json([
            'code'=>200,
            'message' => 'Logro Disicplinario Creado Exitosamente',
        ], Response::HTTP_OK);
    }
    ...
    public function getDataFiltro(Request $request)
    {
        ...
        $data = $request->only('sede_id', 'grado_id', 'periodo_id');
        //Buscamos el producto
        $objeto = $this->model::getDataFiltro($request->sede_id, $request->grado_id,
         $request->periodo_id);
